...
<body class="antialiased min-h-screen" style="background:var(--neutral); color:#222;">
  <div class="flex flex-col w-full">
    ...
    <header class="w-full px-8 py-3" style="background:var(--primary);">
      <div class="flex items-center justify-between w-full">
        ...
        <div class="flex items-center gap-2">
          <img 
            src="<?= "/Proyecto/" . $config['iconoPrincipal'] ?>" 
            alt="logo"
            class="h-14 w-14 object-contain bg-white rounded p-1"
          ...
          <a href="/proyecto/admin/dashboard.php"
           ...
           Administrador
            ...
            <a href="/proyecto/logout.php"
               class="px-3 py-1 rounded bg-white text-black text-sm font-bold">
              Salir
            </a>
    ...
    <!-- NAVBAR + NOMBRE EMPRESA + HAMBURGUESA MOBILE -->
    <nav class="w-full" aria-label="Main navigation" style="background:var(--primary);">
      <div class="mx-auto px-8">

        <!-- INPUT PEER (controla el menú mobile). Debe ser sibling del menú mobile -->
        ...
        <div class="flex items-center justify-between py-3">
          ...
          <!-- Links Desktop -->
          <div class="hidden md:flex items-center gap-3" style="color:var(--accent); font-weight:bold; font-style:italic; letter-spacing:0.5px;">
            ...
            <a class="hover:underline" href="/proyecto/index.php#alquiler">ALQUILERES</a><span>|</span>
            <a class="hover:underline" href="/proyecto/index.php#ventas">VENTAS</a><span>|</span>
          ...
          <div class="md:hidden">
            <label for="nav-toggle" class="p-2 rounded-md cursor-pointer inline-flex items-center">
              <!-- Hamburger icon (se oculta cuando checked) -->
              <svg class="h-6 w-6 peer-checked:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16"></path>
              </svg>
              <!-- Close icon (solo visible cuando checked) -->
              <svg class="h-6 w-6 hidden peer-checked:block" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Menú Mobile: aparece solo en mobile y se anima con peer-checked -->
        <div class="md:hidden overflow-hidden max-h-0 peer-checked:max-h-60 transition-all duration-300 ease-in-out"
          ...
          <nav class="flex flex-col px-2 py-3 gap-2">
            ...
            <a class="block px-3 py-2 hover:underline" href="/proyecto/index.php#alquiler">ALQUILERES</a>
            <a class="block px-3 py-2 hover:underline" href="/proyecto/index.php#ventas">VENTAS</a>
    ...
    <!-- REDES + BARRA DE BÚSQUEDA -->
    <div class="w-full flex items-center justify-between px-8 py-3 flex-wrap gap-3"
