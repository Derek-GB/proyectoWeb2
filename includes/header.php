...
<body class="antialiased min-h-screen" style="background:var(--neutral); color:#222;">
  <div class="flex flex-col w-full">
      ...
      <div class="flex items-center justify-between w-full">
        ...
        <div class="flex flex-col items-start gap-0">
          <img 
            ...
            alt="logo"
            class="h-14 w-14 object-contain bg-white rounded p-1 mb-1"
            style="min-width:56px;"
          >

          <div class="flex flex-col items-start leading-tight mb-1">
            <span class="text-white font-bold text-base sm:text-lg italic tracking-wide">
              UTN SOLUTIONS
            </span>
            <span class="text-white font-bold text-xs sm:text-sm italic tracking-wide">
              REAL STATE
            </span>
          </div>
          ...
          <div class="flex items-center gap-2 mt-1">
            <a href="#">
              <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/facebook.svg"
                   alt="Facebook" class="h-7 w-7 bg-white rounded-full p-1">
            </a>
            <a href="#">
              <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/youtube.svg"
                   alt="YouTube" class="h-7 w-7 bg-white rounded-full p-1">
            </a>
            <a href="#">
              <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/instagram.svg"
                   alt="Instagram" class="h-7 w-7 bg-white rounded-full p-1">
            </a>
          </div>
        </div>
          ...
          <?php if (isLoggedIn()): ?>
            <span class="text-white text-sm font-semibold flex items-center gap-1">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                   viewBox="0 0 24 24"
                   class="w-7 h-7 bg-[var(--accent)] rounded-full p-1">
    ...
    <!-- NAVBAR -->
    <nav class="w-full flex items-center justify-end gap-3 py-3 pr-8"
         style="background:var(--primary); color:var(--accent); 
                font-weight:bold; font-style:italic; letter-spacing:0.5px;">
    ...
    <div class="w-full flex justify-end pr-8 pb-2" style="background:var(--primary);">
      <form action="/proyecto/list.php" method="get" class="flex items-center gap-2">
        <input 
          ...
          class="rounded px-4 py-2 border border-gray-300 
                 focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
          style="min-width:220px;"
        >
        <button type="submit" 
                class="bg-[var(--accent)] p-2 rounded-full hover:bg-yellow-500 transition">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none"
               viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
