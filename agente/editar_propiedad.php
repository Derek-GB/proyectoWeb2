<?php
// Aquí puedes editar una propiedad existente como agente, cambiando los datos que quieras
...
<div class="p-6">
  ...
  <form method="post" enctype="multipart/form-data" class="bg-white p-4 rounded mb-6">
    ...
    <textarea name="brief" placeholder="Descripción breve"
      class="w-full p-2 rounded border mt-2 focus:outline-none focus:ring-2 focus:ring-blue-300"><?= h($editing['descripcionBrevePropiedad'] ?? '') ?></textarea>
    <input name="precio" placeholder="Precio"
      class="w-full p-2 rounded border mt-2 focus:outline-none focus:ring-2 focus:ring-blue-300"
      value="<?= h($editing['precioPropiedad'] ?? '') ?>">
    <input name="ubicacion" placeholder="Ubicación"
      class="w-full p-2 rounded border mt-2 focus:outline-none focus:ring-2 focus:ring-blue-300"
      value="<?= h($editing['ubicacionPropiedad'] ?? '') ?>">
